...
public class Ex4_Casting {
	...
	public static void main(String[] args) {
		...
		num2_1 = (int)1.23; // 소수점을 버려야됨
		
		//강제 타입변환 예 : 계산을 위해 특정값을 일시적으로 변환하는 경우
		double num3_1 = 1/2; // 1/2 는 0.5가 아니라 0
		...
		//더할 때 자동 타입변화를 함
		double num4_3 = num4_1 + num4_2; // num4_1이 실수가 되서 실수 + 실수를 한 후 실수 결과를 실수에 저장
		...
		//int => float 으로 타입변환하기보단 double로 타입변환하여 활용한다. 
